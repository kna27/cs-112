...
public class DoublyLinkedWebPage {
     ...
     * 
     * You still need to handle the special case when the list is empty (current ==
     * null)
     * 
    ...
    private class WebPageDisplay extends JPanel {
        ...
        private void setSite(String siteName) {
            ...
            try {
                ...
                System.out.println(
                        "Error Reading Current Site Image. Make sure you've opened the correct project folder (the 'DoublyLinkedWebPage' folder which contains 'src', 'bin', and 'test')");
            }
        }
